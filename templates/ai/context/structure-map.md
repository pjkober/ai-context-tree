...
| `ai/history/` | created at project start to store session transcripts and conversation summaries |
| `ai/lessons/` | created at project start to store post-mortems, lessons learned, and known issues |
| `ai/runs/` | created at project start to store reusable automated scripts generated by agents |
