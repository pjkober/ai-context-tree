...
- **Template:** [file-templates/ai/history/conver-001-example-transcript.md](../../file-templates/ai/history/conver-001-example-transcript.md)
...
- **Template:** [file-templates/ai/runs/run-001-example-automation.sh](../../file-templates/ai/runs/run-001-example-automation.sh)
