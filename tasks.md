...
- [task-072](tasks/task-072-clarify-history-vs-memory-distinction.md) — Clarify Distinction Between `ai/history/` and `ai/memory/` (done)
- [task-073](tasks/task-073-define-plans-vs-specs-boundary.md) — Define Clear Boundary Between `plans/` and `specs/` (done)
- [task-074](tasks/task-074-add-file-size-enforcement-mechanism.md) — Add File Size Rule Enforcement Mechanism (done)
- [task-075](tasks/task-075-document-manifest-multi-agent-conflict-strategy.md) — Document MANIFEST.md Conflict Resolution for Multi-Agent Scenarios (done)
- [task-076](tasks/task-076-add-runs-script-lifecycle-metadata.md) — Add Lifecycle Metadata Convention for `ai/runs/` Scripts (done)
- [task-077](tasks/task-077-create-project-changelog.md) — Create Populated `CHANGELOG.md` for the Project (done)
- [task-078](tasks/task-078-create-contributing-md.md) — Create `CONTRIBUTING.md` (done)
- [task-079](tasks/task-079-create-real-world-example-project.md) — Create a Real-World Example Project in `examples/` (done)
- [task-080](tasks/task-080-add-cicd-pipeline.md) — Add CI/CD Pipeline to the Project (done)
- [task-081](tasks/task-081-add-specific-tags-to-knowledge-files.md) — Add Specific Tags to Knowledge Files (done)
- [task-082](tasks/task-082-expand-new-feature-workflow.md) — Expand `new-feature.md` Workflow Template (done)
- [task-083](tasks/task-083-add-bugfix-and-release-workflows.md) — Add `bugfix.md` and `release.md` Workflow Templates (done)
- [task-084](tasks/task-084-add-prompts-and-templates-dir.md) — Add Templates for `ai/prompts/` and `ai/templates/` (done)
- [task-085](tasks/task-085-add-semantic-versioning.md) — Add Semantic Versioning to the Standard (done)
- [task-086](tasks/task-086-add-precommit-hook-guidance.md) — Add Pre-commit Hook Guidance to `knowledge/git.md` (done)
