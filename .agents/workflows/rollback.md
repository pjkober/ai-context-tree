...
2. Add a note to `.agents/lessons/` explaining the root cause of the agent mistake.
3. If the mistake was caused by an ambiguous rule, update `.agents/rules/coding.md` to prevent it in future.
