...
**Full Coverage** (Pełne pokrycie testami) is a testing rigor strategy where the AI agent is instructed to write comprehensive unit and integration tests covering all new and modified logical paths. A task or feature is not considered complete unless it meets high-quality coverage thresholds.
