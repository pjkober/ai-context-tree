...
Affected files:
1. `templates/knowledge/git.md` — fully rewritten from Polish to English.
...
- `templates/knowledge/git.md`: all headings, descriptions, and command explanations are now in English.
