...
**Description:**
1. Create `file-templates/knowledge/git.md` template file containing a Polish explanation of Git and basic commands (status, add, restore, commit).
...
- Created `file-templates/knowledge/git.md` template file containing standard Git help documentation in Polish.
