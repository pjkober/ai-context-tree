...
# Task-060: Update Root AGENTS.md

## Goal
Update the root `AGENTS.md` file to reflect the actual directory structure and purpose of the `ai-context-tree` repository, and add the requested guidelines (English documentation, no emoji, implement precisely as requested without extra features, and log/save tasks on file/directory changes).
