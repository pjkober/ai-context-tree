...
3. Add a new "About the templates/ Directory" section documenting:
...
5. Add `knowledge/` entry to `templates/MANIFEST.md`.

## Verification Walkthrough
- `docs/06-initialization-guide.md` updated with all sections above.
- `templates/MANIFEST.md` now includes `knowledge/` entry.
