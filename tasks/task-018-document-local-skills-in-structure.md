...
3. Update `templates/ai/context/structure-map.md` and `docs/03-incremental-growth.md` to include `ai/skills/` in the structure map with its appropriate creation conditions.
