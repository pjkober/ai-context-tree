...
**Description:**
1. Update `templates/ai/rules/security.md` to add `## Safety & Destructive Actions Policy` with `__SAFETY_POLICY__` placeholder.
...
1. **Updated Templates:**
   - Modified `templates/ai/rules/security.md` to contain `## Safety & Destructive Actions Policy` and `__SAFETY_POLICY__` placeholder.
2. **Updated Scripts:**
