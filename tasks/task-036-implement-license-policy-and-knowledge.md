...
**Location:** `create_minimal_structure.sh`, `create_minimal_structure.ps1`, `templates/ai/rules/security.md`, and `knowledge/`
...
2. Update `templates/ai/rules/security.md` to add `## License Policy` with `__LICENSE_POLICY__` placeholder.
...
2. **Updated Rule Files and Scripts:**
   - Updated `templates/ai/rules/security.md` to introduce the `__LICENSE_POLICY__` placeholder.
