...
- `templates/ai/rules/testing.md` (New template)
...
Generate `ai/rules/testing.md` from a new template `templates/ai/rules/testing.md` with these choices. Arrange all questions in setup scripts in a logical category order:
...
2. **Testing template created:** Created `templates/ai/rules/testing.md` with placeholders.
