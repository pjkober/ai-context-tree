...
**Location:** `AGENTS.md` and `file-templates/AGENTS.md`

**Description:**
Update the main entry point `AGENTS.md` (and its corresponding template file in `file-templates/AGENTS.md`) to integrate the new directories and rules:
...
2. **Updated Template File:** Modified `file-templates/AGENTS.md` to match the root file exactly.
